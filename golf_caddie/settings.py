...
AWS_DEFAULT_ACL = None          # ACLs disabled on new buckets; access via presigned URLs
AWS_S3_OBJECT_PARAMETERS = {'CacheControl': 'no-cache, no-store, must-revalidate'}
AWS_QUERYSTRING_AUTH = True     # presigned URLs — works without public bucket policy
AWS_QUERYSTRING_EXPIRE = 604800  # 7-day URL expiry (long enough for bookmarked pages)
